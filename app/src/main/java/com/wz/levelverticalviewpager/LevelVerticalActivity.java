...
public class LevelVerticalActivity extends FragmentActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivBackIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                RedirectUtils.finishActivity(LevelVerticalActivity.this);
            }
        });
            ...
            for (int i = 0; i < mdesignlist.size(); i++) {
                ...
                f.setScrollListener(new scrollPagerListener() {
                    ...
                    public void onScrollPagerListener(int Pixels) {
                        int height = ScreenUtil.px2dip(LevelVerticalActivity.this, Pixels);
                        if (height > 10) {
